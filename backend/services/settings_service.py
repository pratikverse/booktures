...
def get_settings() -> dict:
    ...
    return {
        ...
        "image_mode": values["BOOKTURES_IMAGE_MODE"],
...
def update_settings(payload: dict) -> dict:
    normalized = {
        ...
        "BOOKTURES_IMAGE_MODE": str(payload.get("image_mode", "balanced")).strip().lower(),
